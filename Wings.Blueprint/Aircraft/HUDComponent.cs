...
namespace Wings.Blueprint.Aircraft
{
  public class HUDComponent : VisualComponent, IDerivedComponent
  {
    ...
    {
      string text = $"Air speed: {Converters.MetersSecondToKilometersHour(Aircraft.CurrentAirspeed):N1} km/h. Vrot = ({AircraftPhysics.RotationalVelocity.X:N3} / {AircraftPhysics.RotationalVelocity.Y:N3} / {AircraftPhysics.RotationalVelocity.Z:N3})";
