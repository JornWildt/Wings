...
namespace Wings.Blueprint.Aircraft
{
  public class HUDComponent : VisualComponent, IDerivedComponent
  {
    ...
    {
      string text = $"Air speed: {Converters.MetersSecondToKilometersHour(Aircraft.CurrentAirspeed):N1} km/h. AoA: {MathHelper.ToDegrees(Aircraft.CurrentAngleOfAttack):N0}.";
