...
namespace Wings.Blueprint.Aircraft
{
  public class HUDComponent : VisualComponent, IDerivedComponent
  {
    ...
    {
      string text = $"Air speed: {Converters.MetersSecondToKilometersHour(Aircraft.RelativeAirspeed.X):N1} km/h. AoA: {MathHelper.ToDegrees(Aircraft.AngleOfAttack.X):N0}.";
